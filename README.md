...
## Step 6: Update Your Individual Assignment Specs

- Document the outcome of the task.
- Enter the issue number and hyperlink it.
- Enter the pull request number and hyperlink it.
